define([
...
], function (config, on, dom, domConstruct, esriRequest, watchUtils, Point, LocateViewModel,
  ...
  return class {
    ...
    addDetailTrongTrot() {
      ...
      let divInfo, formGroupNCT, formGroupLCT, formGroupArea, formGroupTime, formGroupTGTH, formGroupTGTT, formGroupCTCD, btnAdd;
    ...
    editDetailTrongTrot(item) {
      let div = document.createElement('div');
      let divInfo, formGroupNCT, formGroupLCT, formGroupArea, formGroupTime, formGroupTGTT, formGroupTGTH, formGroupCTCD, btnEdit;
      divInfo = document.createElement('div');
